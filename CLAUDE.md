...
<!-- source: docs/agent/instructions.md + docs/agent/templates/claude-prefix.md -->

> Claude Code entry: this generated `CLAUDE.md` applies to the repository root.

Local hooks under `.claude/hooks/`, when present, provide mechanical enforcement; the canonical and generated instructions remain authoritative.
